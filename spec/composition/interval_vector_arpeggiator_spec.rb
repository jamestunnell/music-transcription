    ...
    @cases = [
      {
        ...
        :rising_pitch_range => (C3..F3),
        :falling_pitch_range => (F3..C3),
        :rhythm => [0.25],
      ...
      },
      {
        ...
        :rising_pitch_range => (C3...C5),
        :falling_pitch_range => (C5...C3),
        :rhythm => [0.25],
        :expected_rising_arpeggio_over_range => [
          note(0.25, [interval(C3)]),
          note(0.25, [interval(E3)]),
      ...
      },
      {
        ...
        :rising_pitch_range => (Db5..F5),
        :falling_pitch_range => (F5..Db5),
        :rhythm => [0.25],
        :expected_rising_arpeggio_over_range => [
      ...
      },
      {
        ...
        :rising_pitch_range => (G4...A5),
        :falling_pitch_range => (A5...G4),
        ...
        :expected_falling_arpeggio_over_range => [
          note(0.25, [interval(A5)]),
          note(0.25, [interval(G5)]),
          note(0.25),
          note(0.25, [interval(D5)]),
          note(0.25, [interval(B4)]),
          note(0.25),
        ]
      },
    ]
