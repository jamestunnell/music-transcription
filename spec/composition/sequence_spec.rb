...
describe Musicality::Sequence do
  before :all do
    @note1 = Musicality::Note.new(:pitch => Musicality::Pitch.new( :ratio => 15.0 ), :duration => 2)
    @note2 = Musicality::Note.new(:pitch => Musicality::Pitch.new( :ratio => 30.0 ), :duration => 1)
    @note3 = Musicality::Note.new(:pitch => Musicality::Pitch.new( :ratio => 25.0 ), :duration => 3)
  end
