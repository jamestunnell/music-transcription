  ...
  :parts => [
    {
      ...
      :note_sequences => [
        ...
        { :offset => 2.0, :notes => [
            { :duration => 0.25, :pitches => [C3], :relationship => Musicality::Note::RELATIONSHIP_LEGATO },
            { :duration => 0.25, :pitches => [D3], :relationship => Musicality::Note::RELATIONSHIP_LEGATO },
            { :duration => 0.25, :pitches => [E3], :relationship => Musicality::Note::RELATIONSHIP_LEGATO },
            { :duration => 0.25, :pitches => [F3], :relationship => Musicality::Note::RELATIONSHIP_LEGATO },
            { :duration => 0.25, :pitches => [E3], :relationship => Musicality::Note::RELATIONSHIP_LEGATO },
            { :duration => 0.25, :pitches => [D3], :relationship => Musicality::Note::RELATIONSHIP_LEGATO },
            { :duration => 0.5, :pitches => [C3] }
          ]
